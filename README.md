# Cloud Foundry Matlab r2012a Buildpack
...
Then you will need to expand the created zip file, add the `matlab-lib` directory and its contents, and re-zip the folder. This will create the final buildpack you can upload to Cloud Foundry.
